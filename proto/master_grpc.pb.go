...
const (
	RuleEngine_Transaction_FullMethodName = "/ares.RuleEngine/Transaction"
)
...
func (c *ruleEngineClient) Transaction(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, RuleEngine_Transaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRuleEngineServer) Transaction(context.Context, *Request) (*Response, error) {
...
func _RuleEngine_Transaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(RuleEngineServer).Transaction(ctx, in)
	}
...
var RuleEngine_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ares.RuleEngine",
	HandlerType: (*RuleEngineServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Transaction",
			Handler:    _RuleEngine_Transaction_Handler,
		},
	},
